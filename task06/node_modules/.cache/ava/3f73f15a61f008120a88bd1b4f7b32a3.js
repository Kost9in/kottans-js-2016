...
(0, _ava2.default)('Unknown amount of numbers width custom delimeter lol', function (t) {
  var _rec8 = new _powerAssertRecorder();

  t.is(_rec8._expr(_rec8._capt((0, _add2.default)('//lol\n2lol4lol7lol10'), 'arguments/0'), {
    content: 't.is(add(\'//lol\\n2lol4lol7lol10\'), 23)',
    filepath: 'test.js',
    line: 33
  }), 23);
});
//# sourceMappingURL=node_modules/.cache/ava/3f73f15a61f008120a88bd1b4f7b32a3.js.map