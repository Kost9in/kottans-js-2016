...
(0, _ava2.default)('Unknown amount of numbers width delimeter \\n\\r', function (t) {
  ...
  t.is(_rec6._expr(_rec6._capt((0, _add2.default)('2,4\n\r7,10'), 'arguments/0'), {
    content: 't.is(add(\'2,4\\n\\r7,10\'), 23)',
    filepath: 'test.js',
    line: 25
  }), 23);
...
(0, _ava2.default)('Unknown amount of numbers width delimeter \\r', function (t) {
  var _rec7 = new _powerAssertRecorder();

  t.is(_rec7._expr(_rec7._capt((0, _add2.default)('2,4\r7,10'), 'arguments/0'), {
    content: 't.is(add(\'2,4\\r7,10\'), 23)',
    filepath: 'test.js',
    line: 29
  }), 23);
});

(0, _ava2.default)('Unknown amount of numbers width delimeter <br>', function (t) {
  var _rec8 = new _powerAssertRecorder();

  t.is(_rec8._expr(_rec8._capt((0, _add2.default)('2,4<br>7,10'), 'arguments/0'), {
    content: 't.is(add(\'2,4<br>7,10\'), 23)',
    filepath: 'test.js',
    line: 33
  }), 23);
});
//# sourceMappingURL=node_modules/.cache/ava/0ef4c7bdfbdc7ed131585e2a2df549fc.js.map