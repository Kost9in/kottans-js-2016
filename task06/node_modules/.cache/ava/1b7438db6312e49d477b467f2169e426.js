...
var _typeof2 = require('/Users/konstantintihov/Documents/kottans-js-2016/task06/node_modules/ava/node_modules/babel-runtime/helpers/typeof.js');
...
(0, _ava2.default)('Unknown amount of numbers width one negative number', function (t) {
  t.throws(_avaThrowsHelper(function () {
    return function () {
      return (0, _add2.default)('2,4,-7,10');
    };
  }, {
    line: 33,
    column: 11,
    source: '() => add(\'2,4,-7,10\')',
    filename: '/Users/konstantintihov/Documents/kottans-js-2016/task06/test.js'
...
(0, _ava2.default)('Unknown amount of numbers with number bigger 1000', function (t) {
  var _rec8 = new _powerAssertRecorder();

  t.is(_rec8._expr(_rec8._capt((0, _add2.default)('2,4,1000,1001,7,10'), 'arguments/0'), {
    content: 't.is(add(\'2,4,1000,1001,7,10\'), 23)',
    filepath: 'test.js',
    line: 49
  }), 23);
});

(0, _ava2.default)('Unknown amount of numbers width custom delimeter : and number bigger 1000', function (t) {
  var _rec9 = new _powerAssertRecorder();

  t.is(_rec9._expr(_rec9._capt((0, _add2.default)('//:\n2:4:1000:1001:7:10'), 'arguments/0'), {
    content: 't.is(add(\'//:\\n2:4:1000:1001:7:10\'), 23)',
    filepath: 'test.js',
    line: 53
  }), 23);
});
//# sourceMappingURL=node_modules/.cache/ava/1b7438db6312e49d477b467f2169e426.js.map